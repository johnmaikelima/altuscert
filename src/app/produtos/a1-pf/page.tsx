...
export default function CertificadoA1PF() {
  ...
  useEffect(() => {
    ...
    const productSchema = {
      ...
      '@type': 'Product',
      'name': 'Certificado Digital A1 - Pessoa Física (PF)',
      'image': `${baseUrl}/img/certificadopf.jpeg`,
      'description': 'Certificado digital A1 para pessoa física emitido por videoconferência. Válido por 12 meses, ideal para profissionais autônomos que precisam assinar documentos digitalmente e realizar transações seguras.',
      'brand': {
        '@type': 'Brand',
    ...
    const breadcrumbSchema = {
      ...
      'itemListElement': [
        ...
        },
        {
          '@type': 'ListItem',
          'position': 3,
          'name': 'Certificado Digital A1 PF',
          'item': `${baseUrl}/produtos/a1-pf`
        }
      ]
    };
    ...
    const metaTags = [
      { property: 'og:title', content: 'Certificado Digital A1 - Pessoa Física (PF)' },
      { property: 'og:description', content: 'Certificado digital A1 para pessoa física emitido por videoconferência. Válido por 12 meses. Compre agora!' },
      { property: 'og:image', content: `${baseUrl}/img/certificadopf.jpeg` },
      { property: 'og:url', content: `${baseUrl}/produtos/a1-pf` },
      { property: 'og:type', content: 'product' },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:title', content: 'Certificado Digital A1 - Pessoa Física (PF)' },
      { name: 'twitter:description', content: 'Certificado digital A1 para pessoa física emitido por videoconferência. Válido por 12 meses.' },
      { name: 'twitter:image', content: `${baseUrl}/img/certificadopf.jpeg` }
    ];
  ...
  return (
    <PageLayout title="Certificado A1 PF">
      ...
      <div className="w-full bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white p-12 mb-8 shadow-2xl">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-sm text-gray-400 mb-6">
            ...
            <span> / </span>
            <span className="font-semibold text-blue-400">Certificado Digital A1 PF</span>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
            <div className="flex-1">
              ...
              <p className="text-xl text-blue-400 font-semibold mb-6">Pessoa Física (PF)</p>
              <Link href="/checkout?tipo=a1-pf" className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-10 py-4 rounded-lg font-bold transition text-center whitespace-nowrap shadow-lg hover:shadow-xl inline-block">
                COMPRE AGORA
              </Link>
            </div>
            <div className="w-full md:w-64 flex-shrink-0">
              <Image
                src="/img/certificadopf.jpeg"
                alt="Certificado Digital A1 PF"
                width={300}
                height={300}
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-10 pt-8 border-t border-gray-700">
            ...
            <div className="group">
              ...
              <p className="text-4xl font-bold bg-gradient-to-r from-blue-400 to-blue-300 bg-clip-text text-transparent group-hover:from-blue-300 group-hover:to-blue-200 transition">R$ 85,00</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            O Certificado Digital A1 para Pessoa Física garante a autenticidade, integridade e validade jurídica das transações eletrônicas. 
            Ideal para profissionais autônomos e pessoas que precisam assinar documentos digitalmente.
          </p>
        ...
        <div className="mb-12">
          ...
          <div className="bg-gray-50 p-8 rounded-lg border border-gray-200">
            <ul className="space-y-4">
              ...
              <li className="flex gap-3">
                <span className="text-blue-900 font-bold">✓</span>
                <span className="text-gray-700"><strong>Aplicação:</strong> Pessoa Física (CPF)</span>
              </li>
              <li className="flex gap-3">
                <span className="text-blue-900 font-bold">✓</span>
        ...
        <div className="mb-12">
          ...
          <div className="bg-yellow-50 p-8 rounded-lg border border-yellow-200">
            <p className="text-gray-700 mb-4">O Certificado A1 PF é ideal para:</p>
            <ul className="space-y-2 text-gray-700">
              <li>• Profissionais autônomos que precisam assinar documentos digitalmente</li>
              <li>• Pessoas que realizam transações eletrônicas</li>
              <li>• Indivíduos que precisam cumprir obrigações fiscais digitais</li>
              <li>• Pessoas que buscam segurança nas comunicações eletrônicas</li>
              <li>• Qualquer pessoa que necessite de identidade digital</li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-blue-900 text-white p-8 rounded-lg text-center mb-12">
          ...
          <Link href="/checkout?tipo=a1-pf" className="inline-block bg-white text-blue-900 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition">
            Comprar Agora - R$ 85,00
          </Link>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="space-y-4">
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
              ...
              <p className="text-gray-700">O certificado A1 PF tem validade de 12 meses (1 ano) a partir da data de emissão.</p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-2xl p-4 z-40">
        <Link href="/checkout?tipo=a1-pf" className="w-full bg-blue-600 hover:bg-blue-700 text-white px-6 py-4 rounded-lg font-bold transition text-center block">
          COMPRE AGORA - R$ 85,00
        </Link>
      </div>
